...
@Path("/ui/api/trino-cluster-stats")
public class MWClusterStatsResource
{
    ...
    @Inject
    public MWClusterStatsResource(NodeSchedulerConfig nodeSchedulerConfig, InternalNodeManager nodeManager, DispatchManager dispatchManager, ClusterMemoryManager clusterMemoryManager)
    {
